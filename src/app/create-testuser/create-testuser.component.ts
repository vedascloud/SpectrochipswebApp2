...
@Component({
  selector: 'app-create-testuser',
  templateUrl: './create-testuser.component.html',
  styleUrls: ['./create-testuser.component.css'],
  providers: [UserService]
})
export class CreateTestuserComponent {
  ...
  onSubmit() {
    ...
    this.userService.insertUserTestfile(formModel)
      .subscribe(
        user => {
